...
class TestPart1:
    ...
    EXPECTED = {
        "test.txt": 2024,  # TODO: Add expected test value from puzzle description
        "data.txt": 48063513640678,
    }
...
class TestPart2:
    ...
    EXPECTED = {
        "test2.txt": None,  # TODO: Add expected test value from puzzle description
        "data.txt": "hqh,mmk,pvb,qdq,vkq,z11,z24,z38",
    }
