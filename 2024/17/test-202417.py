...
class TestPart1:
    ...
    EXPECTED = {
        "test.txt": "4,6,3,5,6,3,5,2,1,0",  # TODO: Add expected test value from puzzle description
        "data.txt": "5,1,4,0,5,1,0,2,6",
    }
...
class TestPart2:
    ...
    EXPECTED = {
        "test.txt": 117440,  # TODO: Add expected test value from puzzle description
        "data.txt": 202322936867370,
    }
