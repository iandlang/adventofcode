...
class TestPart1:
    ...
    EXPECTED = {
        "test.txt": 7,  # TODO: Add expected test value from puzzle description
        "data.txt": 1098,
    }
...
class TestPart2:
    ...
    EXPECTED = {
        "test.txt": "co,de,ka,ta",  # TODO: Add expected test value from puzzle description
        "data.txt": "ar,ep,ih,ju,jx,le,ol,pk,pm,pp,xf,yu,zg",
    }
