...
class TestPart1:
    ...
    EXPECTED = {
        "test.txt": 6,  # TODO: Add expected test value from puzzle description
        "data.txt": 269,
    }
...
class TestPart2:
    ...
    EXPECTED = {
        "test.txt": 16,  # TODO: Add expected test value from puzzle description
        "data.txt": 758839075658876,
    }
