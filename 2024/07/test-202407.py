...
class TestPart1:
    ...
    EXPECTED = {
        "test.txt": 3749,  # TODO: Add expected test value from puzzle description
        "data.txt": 303766880536,
    }
...
class TestPart2:
    ...
    EXPECTED = {
        "test.txt": 11387,  # TODO: Add expected test value from puzzle description
        "data.txt": 337041851384440,
    }
