...
class TestPart1:
    ...
    EXPECTED = {
        "test.txt": 55312,  # TODO: Add expected test value from puzzle description
        "data.txt": 203609,
    }
...
class TestPart2:
    ...
    EXPECTED = {
        "test.txt": None,  # TODO: Add expected test value from puzzle description
        "data.txt": 240954878211138,
    }
