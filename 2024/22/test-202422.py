...
class TestPart1:
    ...
    EXPECTED = {
        "test.txt": 37327623,  # TODO: Add expected test value from puzzle description
        "data.txt": 14082561342,
    }
...
class TestPart2:
    ...
    EXPECTED = {
        "test2.txt": 23,  # TODO: Add expected test value from puzzle description
        "data.txt": 1568,
    }
